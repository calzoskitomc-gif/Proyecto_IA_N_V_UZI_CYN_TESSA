...
if not DISCORD_TOKEN:
    raise SystemExit(
        "Falta DISCORD_TOKEN. En Termux: export DISCORD_TOKEN='tu_token' antes "
        "de correr el script (o ponlo en un .env que NO subas a git). En "
        "Render: Environment > DISCORD_TOKEN en el dashboard del servicio."
    )
if not GROQ_API_KEY:
    raise SystemExit(
